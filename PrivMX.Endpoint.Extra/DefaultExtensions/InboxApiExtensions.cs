...
public static class InboxApiExtensions
{
	...
	public static ValueTask<string> CreateInboxAsync(this IInboxApi inboxApi, string contextId,
		List<UserWithPubKey> users, List<UserWithPubKey> managers, byte[] publicMeta, byte[] privateMeta,
		FilesConfig filesConfig, ContainerPolicyWithoutItem? policies = null, CancellationToken token = default)
	{
		if (inboxApi is null)
			throw new ArgumentNullException(nameof(inboxApi));
		return WrapperCallsExecutor.Execute(
			() => inboxApi.CreateInbox(contextId, users, managers, publicMeta, privateMeta, filesConfig, policies),
			token);
	}

	public static ValueTask UpdateInboxAsync(this IInboxApi inboxApi, string inboxId, List<UserWithPubKey> users,
		List<UserWithPubKey> managers, byte[] publicMeta, byte[] privateMeta, FilesConfig filesConfig, long version,
		bool force, bool forceGenerateNewKey, ContainerPolicyWithoutItem? policies = null,
		CancellationToken token = default)
	{
		if (inboxApi is null)
			throw new ArgumentNullException(nameof(inboxApi));
		return WrapperCallsExecutor.Execute(
			() => inboxApi.UpdateInbox(inboxId, users, managers, publicMeta, privateMeta, filesConfig, version, force,
	...
	public static ValueTask<InboxPublicView> GetInboxPublicViewAsync(this IInboxApi inboxApi, string inboxId,
		CancellationToken token = default)
	{
		if (inboxApi is null)
			throw new ArgumentNullException(nameof(inboxApi));
		...
		List<long> inboxFileHandles, string userPrivKey, CancellationToken token = default)
	{
		if (inboxApi is null)
			throw new ArgumentNullException(nameof(inboxApi));
		return WrapperCallsExecutor.Execute(() => inboxApi.PrepareEntry(inboxId, data, inboxFileHandles, userPrivKey),
			token);
	}
	...
	public static ValueTask<InboxEntry> ReadEntryAsync(this IInboxApi inboxApi, string inboxEntryId,
		CancellationToken token = default)
	{
		if (inboxApi is null)
			throw new ArgumentNullException(nameof(inboxApi));
	...
	public static ValueTask<PagingList<InboxEntry>> ListEntriesAsync(this IInboxApi inboxApi, string inboxId,
		PagingQuery pagingQuery, CancellationToken token = default)
	{
		if (inboxApi is null)
			throw new ArgumentNullException(nameof(inboxApi));
	...
	public static ValueTask DeleteEntryAsync(this IInboxApi inboxApi, string inboxEntryId,
		CancellationToken token = default)
	{
		if (inboxApi is null)
			throw new ArgumentNullException(nameof(inboxApi));
	...
	public static ValueTask<long> CreateFileHandleAsync(this IInboxApi inboxApi, byte[] publicMeta, byte[] privateMeta,
		long fileSize, CancellationToken token = default)
	{
		if (inboxApi is null)
			throw new ArgumentNullException(nameof(inboxApi));
	...
	public static ValueTask WriteToFileAsync(this IInboxApi inboxApi, long inboxHandle, long inboxFileHandle,
		byte[] dataChunk, CancellationToken token = default)
	{
		if (inboxApi is null)
			throw new ArgumentNullException(nameof(inboxApi));
	...
	public static ValueTask<long> OpenFileAsync(this IInboxApi inboxApi, string fileId,
		CancellationToken token = default)
	{
		if (inboxApi is null)
			throw new ArgumentNullException(nameof(inboxApi));
	...
	public static ValueTask<byte[]> ReadFromFileAsync(this IInboxApi inboxApi, long fileHandle, long length,
		CancellationToken token = default)
	{
		if (inboxApi is null)
			throw new ArgumentNullException(nameof(inboxApi));
	...
	public static ValueTask SeekInFileAsync(this IInboxApi inboxApi, long fileHandle, long position,
		CancellationToken token = default)
	{
		if (inboxApi is null)
			throw new ArgumentNullException(nameof(inboxApi));
	...
	public static ValueTask<string> CloseFileAsync(this IInboxApi inboxApi, long fileHandle,
		CancellationToken token = default)
	{
		if (inboxApi is null)
			throw new ArgumentNullException(nameof(inboxApi));
	...
	public static ValueTask SubscribeForEntryEventsAsync(this IInboxApi inboxApi, string inboxId,
		CancellationToken token = default)
	{
		if (inboxApi is null)
			throw new ArgumentNullException(nameof(inboxApi));
	...
	public static ValueTask UnsubscribeFromEntryEventsAsync(this IInboxApi inboxApi, string inboxId,
		CancellationToken token = default)
	{
		if (inboxApi is null)
			throw new ArgumentNullException(nameof(inboxApi));
