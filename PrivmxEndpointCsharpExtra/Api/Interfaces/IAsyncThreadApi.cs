...
public interface IAsyncThreadApi
{
    ...
    /// <param name="managers">
    ///     List of <see cref="UserWithPubKey" /> indicating who will have access (and management rights) to
    ///     the created Thread.
    /// </param>
    ...
    ValueTask<string> CreateThreadAsync(string contextId, List<UserWithPubKey> users, List<UserWithPubKey> managers,
		byte[] publicMeta, byte[] privateMeta, ContainerPolicy? containerPolicy = null,
